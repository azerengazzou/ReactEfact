  ...
  return (
    <>
      ...
      <div className="grid gap-6 mb-4 md:grid-cols-2">
        <Card>
          <CardBody>
            <p className="mb-4 font-semibold text-gray-600 dark:text-gray-300">Statistiques des utilisateurs</p>
            ...
            <div className="grid gap-2 mb-2 md:grid-cols-2 xl:grid-cols-2">
              ...
              <Card>
                <CardBody>
                  <p className="mb-4 font-semibold text-gray-600 dark:text-gray-300">Liste des administrateurs:</p>
                  {administrators && administrators.map((admin, index) => (
                    <div key={index}>
                      <p className="text-gray-600 dark:text-gray-400">Nom et Prénom: {admin.firstName} {admin.lastName}</p>
                      <p className="text-gray-600 dark:text-gray-400">Email: {admin.email}</p>
                      <p className="text-gray-600 dark:text-gray-400">Date d'ajout: {moment(admin.addDate).format('DD/MM/YYYY HH:mm')}</p>
                      <br/>
                    </div>
                  ))}
                </CardBody>
        ...
        <Card>
          <CardBody>
            <p className="mb-4 font-semibold text-gray-600 dark:text-gray-300">Statistiques de configuration</p>
            ...
            <div className="grid gap-2 mb-2 md:grid-cols-2 xl:grid-cols-2">
              ...
              <InfoCard title="Total des erreurs détectables" value="2654">
                <RoundIcon
                  icon={FormsIcon}
                  iconColorClass="text-orange-500 dark:text-orange-100"
                  className="mr-4"
      ...
      <div className="grid gap-1 mb-4 md:grid-cols-1">
      <Card>
          <CardBody>
            <p className="mb-4 font-semibold text-gray-600 dark:text-gray-300">Vue d'ensemble</p>
            <div className="grid gap-6 mb-4 md:grid-cols-2">
            <ChartCard title="Nombre d'utilisateurs / Date de rejoindre ">
                <Bar {...barOptions} />
                <ChartLegend legends={barLegends} />
              </ChartCard>
              <ChartCard title="Statistiques ticket par status">
                <Doughnut {...DashOptions} />
                <ChartLegend legends={DashLegend} />
              </ChartCard>
            </div>
          </CardBody>
        </Card>
